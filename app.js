...
app.post('/campspots', catchAsync(async(req, res) => {
...
app.all('*', (req, res, next) => {
    next(new ExpressError('For some reason... This page can not be seen at the moment', 404));
})
...
app.use((err, req, res, next) =>{
    ...
    res.send('uugghh, something went wrong');
})
